...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--display_freq', type=int, default=400, help='frequency of saving a sample-image grid to [opt.checkpoints_dir]/[opt.name]/samples/')
        parser.add_argument('--print_freq', type=int, default=100, help='frequency of writing training losses to the log file')
